...
def get_input_args():
    ...
    parser.add_argument('directory', type = str, default = 'flowers', help = 'directory of the main image file containing the folder root/train/[setnumber]/images.jpg and root/test/[setnumber]/image.jpg')
